		...
		<div class="container panel-margin">
			...
			<div class="row text-center">
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/image(1).jpg" alt="camera">
						<div class="caption">
							<h3>Canon EOS 1500D</h3>
							<p>Price: <i class="fa fa-rupee"></i> 54,000</p>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/image(2).jpg" alt="camera">
						<div class="caption">
							<h3>Fujifilm Instax Mini 9 Instant</h3>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/image(3).jpg" alt="camera">
						<div class="caption">
							<h3>Canon EOS 6D Mark II</h3>
							<p>Price: <i class="fa fa-rupee"></i> 23,000</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
							<a href="login.php" type="button" class="btn btn-primary">Add to cart</a>
							<?php }else{ ?>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/image(4).jpg" alt="camera">
						<div class="caption">
							<h3>Canon PowerShot SX430</h3>
							<p>Price: <i class="fa fa-rupee"></i> 49,000</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
							<a href="login.php" type="button" class="btn btn-primary">Add to cart</a>
							<?php }else{ ?>
